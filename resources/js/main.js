...
function showInfo() {
    ...
    document.getElementById('info').innerHTML = `
        ${NL_APPID} is running on port ${NL_PORT} test inside ${NL_OS}
        <br/><br/>
...
*/
async function openDocs(data) {
    const winObj = await Neutralino.window.create("/html/cc.html", {
        title: 'Tutorial',
        borderless: false,
        width: 600,
        height: 500,
    ...
    if (winObj) {
        observer.publish(winObj.pid, data);
    }
    console.log(winObj);
